//
//  Video_Convert_Image.c
//  ffApp
//
//  Created by 苏莫离 on 2018/3/24.
//

#include "Video_Convert_Image.h"
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
#include "libavformat/avformat.h" /// 多媒体文件相关
...
//}
//
//int video_convert_image(const char *inputfile, const char *outfile) {
//    int ret;
//    FILE *f;
//
...
//                av_get_media_type_string(AVMEDIA_TYPE_VIDEO), inputfile);
//        return ret;
//    }
//
//    stream_index = ret;
...
//            if (decode_write_frame(outfile, c, img_convert_ctx, frame, &frame_count, &avpkt, 0) < 0)
//                exit(1);
//        }
//
...
//    avpkt.data = NULL;
//    avpkt.size = 0;
//    decode_write_frame(outfile, c, img_convert_ctx, frame, &frame_count, &avpkt, 1);
//
//    fclose(f);
//
