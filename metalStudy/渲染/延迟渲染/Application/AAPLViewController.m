...
- (void)viewDidLoad {
    ...
    if(@available( macOS 11, * )) {
        // On macOS, the MTLGPUFamilyApple1 enum is only avaliable on macOS 11.
        // On macOS 11 check if running on an Apple Silicon GPU to use the single pass deferred renderer
