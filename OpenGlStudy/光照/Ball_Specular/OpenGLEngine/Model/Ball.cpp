...
//    memcpy(mNormalBuffer, mVertexBuffer, size(ver));
    mNormalBuffer = ver;
//    mNormalBuffer = nbb.asFloatBuffer();//◊™ªªŒ™float–Õª∫≥Â
//    mNormalBuffer.put(vertices);//œÚª∫≥Â«¯÷–∑≈»Î∂•µ„∑®œÚ¡ø ˝æ›
//    mNormalBuffer.position(0);//…Ë÷√ª∫≥Â«¯∆ ºŒª÷√
}
